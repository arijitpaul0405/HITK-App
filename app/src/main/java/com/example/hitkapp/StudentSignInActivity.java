...
public class StudentSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.circleImage.setImageResource(R.drawable.student_icon);
        binding.textHeading.setText(R.string.student_log_in);
        ...
        _auth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()) {
                        ...
                        if(user != null) {
                            Toast.makeText(StudentSignInActivity.this, "Login Successfully!", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(StudentSignInActivity.this, StudentPageActivity.class);
                            startActivity(intent);
                            StudentSignInActivity.this.finish();
                        }
                    }
                    else {
                        Toast.makeText(StudentSignInActivity.this, "Please verify your email and password!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
